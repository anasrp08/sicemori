@extends('layouts.app')
@section('dashboard')
Master Data Tipe Pita Cukai
<small>{!! auth()->user()->name !!}</small>
@endsection

@section('breadcrumb')
<li><a href="{{ url('home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
<li class="active">Master Data Tipe Pita Cukai</li>
@endsection
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <table id="tipepikai" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        <th>No.</th>
                        <th>Tipe Pikai</th>
