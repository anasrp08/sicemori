@extends('layouts.app')
@section('dashboard')
Master Data Petugas Task Force Beacukai
<small>{!! auth()->user()->name !!}</small>
@endsection

@section('breadcrumb')
<li><a href="{{ url('home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
<li class="active">Master Data Petugas</li>
@endsection
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <table id="mdpetugas" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        <th>Nama Petugas</th>
                        <th>Nomor Pegawai</th>
