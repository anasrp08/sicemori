                ...
                <table id="pesanan" class="table table align-items-center table-striped" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="select-filter">Order Terkhir</th>
                            <th class="select-filter">Seri Terakhir</th>

                            <th>Jumlah Pesanan(Tanpa Insit)</th>
                            <th>Target Insit (%)</th>
                            <th>Target Jumlah Insit (Bilyet)</th>
                            <th>Target Lembar Insit</th>
                            <th>Target Order Tanpa Insit</th>
                            <th>Target Order Insit</th>
                            <th>Total Order</th>
                            <th>Total Pesanan (Bilyet)</th>
                            <th>Action</th>
