...
<head>
    ...
    <link href="{{ asset('/argon/assets/img/brand/logo.png')}}" rel="icon" type="image/png">
  <!-- Fonts -->
...
<body class="">
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="./index.html">
        <img src="{{ asset('/argon/assets/img/theme/logo.png')}}" class="navbar-brand-img" alt="..."> SICEMORI
      </a>
      <!-- User -->
          ...
          <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              <span class="avatar avatar-sm rounded-circle">
                <img alt="Image placeholder" src="{{ asset('/argon/assets/img/theme/logo.png')}}">
              </span>
            </div>
          </a>
            ...
            <div class="row align-items-center justify-content-xl-between">
              <div class="col-xl-6">
                <div class="copyright text-center text-xl-left text-muted">
                    Copyright &copy; {!! date("Y") !!} <a href="#" class="font-weight-bold ml-1" target="_blank">By Peruri Div. TI</a>
                </div>
              </div>
              <div class="col-xl-6">
                <ul class="nav nav-footer justify-content-center justify-content-xl-end">
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link" target="_blank">Dept. Pengembangan</a>
                  </li>
                </ul>
              </div>
            </div>
  ...
  <!--   Optional JS   -->
  {{-- <script ssrc="{{ asset('/argon/assets/js/plugins/chart.js/dist/Chart.min.js')}}"></script>
  ...
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.18.1/moment.min.js"></script>
   <script src="{{ asset('/adminlte/input-mask/jquery.inputmask.js')}}"></script>
        ...
        <script src="{{ asset('/argon/assets/js/bootstrap-datepicker.min.js')}}"></script>
        <script src="{{ asset('/argon/assets/js/argon1.min.js')}}"></script>
        {{-- <script
...
<script>
    ...
    setInterval(function(){
        $.ajax({
          url: "{{route('lampiranorder.getUpdate')}}",
          success: function( data ) {
              if(data.dataUpdate != ""){
                 ...
                 for(i=0;i<data.length;i++){
                    ...
                    toastr.error("Pecahan: "+data[i].pecahan
                    +" Nomor Order: "+data[i].order
                    +" Keterangan: "+data[i].keterangan
                    +" No Seri: "+data[i].noseri,
                 ...
                 toastr.options.onclick = function() { 
                    $.ajax({
          url: "{{route('lampiranorder.delUpdate')}}",
          success: function( data ) {
              console.log(data)
