        ...
        <div class="card card-profile shadow">
            ...
            <div class="card-body pt-0 pt-md-4">
                <div class="text-center" style="margin-top: 5rem;">
                    <h3>
                        <span class="font-weight-light">Total Pesanan</span> <span id="total_pesanan">xxxxxxx</span>
                    </h3>
                </div>
                <div class="row">
        ...
        <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
                <form method="post" id="create_pesanan" enctype="multipart/form-data">
                    ...
                    <hr class="my-4" />
                    <!-- Address -->
                    <h6 class="heading-small text-muted mb-4">Nomor Seri Uang Terakhir</h6>
                    <div class="pl-lg-4">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="seri_terakhir" id="seri_terakhir" class="form-control"
                                        ...
                                        data-inputmask='"mask": "A A A  A A A"' readonly>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-city">Seri Nomor Akhir</label>
                                    {{-- <label for="seriterakhir">Seri Terakhir</label> --}}
                    ...
                    <hr class="my-4" />
                    <h6 class="heading-small text-muted mb-4">Nomor Order Terakhir</h6>
                    <div class="pl-lg-4">

                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-city">Nomor Order Terakhir</label>
                                    {{-- <label for="seriterakhir">Seri Terakhir</label> --}}
                                    <input type="text" name="order_terakhir" id="order_terakhir" class="form-control"
                                        placeholder=" order terakhir" value="" readonly data-inputmask-regex=" \d{2}"
                                        data-mask>
                                </div>
                            </div>
