...
return data + ' ('+row.ta+')'
        ...
        //             console.log(data)
        //             var dataOrderNKRI = data.dataOrderNKRI
        //             var dataLembartercetak = data.dataLembartercetak
        //             var dataOrderRilis = data.dataOrderRilis
        //             var dataLpkTerbit = data.dataLpkTerbit
        //             var dataLpkSelesai = data.dataLpkSelesai
        //             var dataLiniA = data.dataLiniA
        //             var dataLiniB = data.dataLiniB

        //             var pecahan = ['S', 'T', 'U', 'V', 'W', 'X', 'Y']
        //             var pecahanid = ['s', 't', 'u', 'v', 'w', 'x', 'y']

        //             for (i = 0; i < dataOrderNKRI.length; i++) {
        //                 $('#' + dataOrderNKRI[i].pecahan.toLowerCase() + 'ordernkri').text(
        //                     dataOrderNKRI[i].jumlah)
        //             }

        //             for (i = 0; i < dataLembartercetak.length; i++) {
        //                 $('#' + dataLembartercetak[i].pecahan.toLowerCase() + 'lbrtercetak').text(
        //                     dataLembartercetak[i].jumlah)
        //             }

        //             for (i = 0; i < dataOrderRilis.length; i++) {
        //                 $('#' + dataOrderRilis[i].pecahan.toLowerCase() + 'orderterbit').text(
        //                     dataOrderRilis[i].jumlah)
        //             }

        //             for (i = 0; i < dataLpkTerbit.length; i++) {
        //                 $('#' + dataLpkTerbit[i].pecahan.toLowerCase() + 'lpkterbit').text(
        //                     dataLpkTerbit[i].jumlah)
        //             }

        //             for (i = 0; i < dataLpkSelesai.length; i++) {
        //                 $('#' + dataLpkSelesai[i].pecahan.toLowerCase() + 'lpkselesai').text(
        //                     dataLpkSelesai[i].jumlah)
        //             }

        //             for (i = 0; i < dataLiniA.length; i++) {
        //                 $('#' + dataLiniA[i].pecahan.toLowerCase() + 'tercetaklinia').text(
        //                     dataLiniA[i].jumlah)
        //             }

        //             for (i = 0; i < dataLiniB.length; i++) {
        //                 $('#' + dataLiniB[i].pecahan.toLowerCase() + 'tercetaklinib').text(
        //                     dataLiniB[i].jumlah)
        //             }

        //             //   for(i=0;i<dataOrderNKRI.length;i++){

        //             //         // console.log(dataOrderNKRI[i].pecahan)
        //             //         $('#'+dataOrderNKRI[i].pecahan.toLowerCase()+'ordernkri').text(dataOrderNKRI[i].jumlah)
        //             //         $('#'+dataLembartercetak[i].pecahan.toLowerCase()+'lbrtercetak').text(dataLembartercetak[i].jumlah)
        //             //         $('#'+dataOrderRilis[i].pecahan.toLowerCase()+'orderterbit').text(dataOrderRilis[i].jumlah)


        //             //         $('#'+dataLpkTerbit[i].pecahan.toLowerCase()+'lpkterbit').text(dataLpkTerbit[i].jumlah)
        //             //         $('#'+dataLpkSelesai[i].pecahan.toLowerCase()+'lpkselesai').text(dataLpkSelesai[i].jumlah) 
        //             //         $('#'+dataLiniA[i].pecahan.toLowerCase()+'tercetaklinia').text(dataLiniA[i].jumlah)
        //             //         $('#'+dataLiniB[i].pecahan.toLowerCase()+'tercetaklinib').text(dataLiniB[i].jumlah)

        //             //   }

        //             // $('#sordernkri').text(dataLbrCetak[0].dataOrderNKRI)
        //             // $('#slbrtercetak').text()
        //             // $('#sorderterbit').text()
        //             // $('#slpkterbit').text()
        //             // $('#slpkselesai').text()
